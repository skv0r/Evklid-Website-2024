      ...
      <div className="container footer__shape">
        <div className="footer__card">
          <div className="footer__card-item footer__nav-shape">
            ...
            <nav className="footer__nav"> 
              <ul className="footer__nav-list list-reset">
                ...
                <li className="footer__nav-list-item"><a className="footer__text" href="/docs/offer.txt" download>Договор оферты</a></li>
                <li className="footer__nav-list-item"><a className="footer__text" href="/docs/contract.txt" download>Договор подряда</a></li>
                <li className="footer__nav-list-item"><a className="footer__text" href="/docs/privacy.txt" download>Конфиденциальность</a></li>
                <li className="footer__nav-list-item"><a className="footer__text" href="/docs/partner.txt" download>Партнёрское соглашение</a></li>
              </ul>
            </nav>    
            <div className="footer__nav-svg">
              {/* ... (svg paths) */}
              <a aria-label="Одноклассники" className="footer__svg-icon" href="https://ok.ru/">
              ...
              <a aria-label="Вконтакте" className="footer__svg-icon" href="https://vk.com/">
                <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="footer__card-item footer__form-shape">
            ...
            <form action="https://jsonplaceholder.typicode.com/posts" method="POST" onSubmit={handleSubmit}>
              <div className="footer__form-input">
                ...
                <div className="footer__form-button">
                  ...
                  <div className="footer__checkbox">
                    <input 
                      className="footer__checkbox-input" 
                      type="checkbox" 
                      id="checkbox" 
                      name="checkbox" 
                      checked={isChecked}
          ...
          <div className="footer__card-item footer__card-shape">
            <p className="footer__paragraph paragraph-text">Компания «Евклид» — это надежный партнер в&nbsp;сфере капитального строительства и&nbsp;реконструкции. Мы&nbsp;предлагаем инновационные решения, которые позволяют оптимизировать затраты без потери качества. Наш подход основан на&nbsp;прозрачности отношений с&nbsp;клиентом и&nbsp;безупречном исполнении взятых на&nbsp;себя обязательств в&nbsp;области гражданского и&nbsp;промышленного строительства.</p>
          </div>
        </div>
      </div>
    </footer>
